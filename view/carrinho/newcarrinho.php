...
<?php
 ...
 <li class="list-group-item py-3" id="caixa-valor-total">
      <div class="text-end" >
        <form action="../frete/frete/calcular.php" method="post">
          <label for="frete">Calcular frete</label>
          <input type="hidden" value="1" name="calFrete">
          <input type="text" value="" placeholder="Digite seu Cep" name="frete" required>
        ...
        <?php
             ...
             if(isset($_GET['valor'])){
              ?>
              <h6>
                Valor Subtotal:<?php echo number_format($total,2,',','.');?>
              </h6>
              <h5>
                Valor Frete:<?php  $valorFrete = $_GET['valor']; echo $valorFrete;?>
              </h5>
               <?php @$total =  $valorFrete + $total;?>
              <h4 class="text-dark mb-3" >
                Valor Total:<?php echo number_format($total,2,',','.');?>
              </h4>
              <?php
              $_SESSION['previsao'] = $_GET['previsao'];
