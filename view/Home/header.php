...
<head>
    ...
    <link rel="stylesheet" href="view/home/css/header.css?key=<?php echo $key?>">
...
<header>
          <nav class="nav-bar">
            <div class="logo">
              <a href="#" style="margin: 0;"><img src="view/img/icons/logo.png" class="img-fluid"alt="Imagem responsiva"></a>
            </div>
...
<div class="area-pesquisar" id="area-pesquisar">
  <span class="img-pesquisar" onclick="pesquisar();"><img src="view/img/icons/pesquisar.png" alt="logo de uma lupa" class="img-fluid"></span>
</div>
</div>
  </form>
<div class="icons">
<div class="login-button">
<div class="img-icon"><a href="view/meusPedidos/perfilUsuario.php"><img src="view/img/icons/icon.png" style="width: 40px; height: 40px;"id="img-profile-user"></a></div>
</div>
<div class="carrinho-button">
<div class="img-icon"><a href="view/carrinho/newcarrinho.php"><img src="view/img/icons/carrinho-compras.png" style="width: 40px; height: 40px;" id="img-shopping-bag"></a></div>
</div>
<div class="mobile-menu-icon">
<button onclick="menuShow()">
<img class="icon" src="view/home/img/menu/menu.png" style="width: 30px; height: 30px;"></button>
</div>
</nav>
