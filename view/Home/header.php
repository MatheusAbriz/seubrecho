...
<head>
    ...
    <link rel="stylesheet" href="css/header.css?key=<?php echo $key?>">
...
<header>
          <nav class="nav-bar">
            <div class="logo">
              <a href="index.php" style="margin: 0;"><img src="view/img/logoylogo.png" class="img-fluid"alt="Imagem responsiva"></a>
            </div>
...
<button class="btn"><a class="nav-item" hreindex.php">INICIO</a></button>
...
<div class="img-icon"><a href="view/perfil/meuspedidos.php"><img src="view/home/img/pay/user.png" style="width: 30px; height: 30px;" id="img-profile-user"></a></div>
</div>
<div class="carrinho-button">
<div class="img-icon"><a href="view/carrinho/newcarrinho.php"><img src="view/home/img/pay/shopping-bag.png" style="width: 30px; height: 30px;" id="img-shopping-bag"></a></div>
</div>
